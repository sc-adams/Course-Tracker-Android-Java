...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graph_button.setOnClickListener(view -> {
            ...
            // send data to the intent for use in the graph activity
    ...
    private void loadUIData(){
        ...
        if (cursor != null) {
            if (cursor.getCount() == 0) { // if there is nothing in the cursor
                ...
                if (cursor.moveToFirst()) { // while there is a ne
                    do {
    ...
    private void handleSMS(){
        // Handling SMSService Preferences
        ...
        // check if the sms switch is set to on
        if (smsSwitchState) {
