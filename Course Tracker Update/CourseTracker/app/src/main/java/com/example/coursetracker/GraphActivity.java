...
public class GraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartTextView.setTextSize(28.0f); // set the text size
        refreshPieChart();
    }
    @Override
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(dataUpdateReceiver, new IntentFilter("data_updated"), Context.RECEIVER_NOT_EXPORTED);  // ✅
        } else {
            registerReceiver(dataUpdateReceiver, new IntentFilter("data_updated"));
        }

        refreshPieChart(); // handle dynamic updates
    }
    ...
    private final BroadcastReceiver dataUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && "data_updated".equals(intent.getAction())) {
                refreshPieChart(); // refresh the chart when new data comes from the intent
            }
        }
    };
    ...
    private void refreshPieChart() {
        ...
        if (intent != null) {
            ...
            if (measurementTitles != null && measurementDescriptions != null && measurementPercents != null) {
                ...
                pieData.setValueTextSize(20.0f); // set the font size
                ...
                pieChart.getLegend().setTextSize(20.0f); // set the text size and color
